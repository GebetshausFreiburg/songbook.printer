...
/**
 * This class is a scanner generated by <a href="http://www.jflex.de/">JFlex</a> 1.6.1 from the specification file <tt>SongParserLogic.jflex</tt>.
 * 
 * Commands java -jar jflex-1.6.1.jar SongParserLogic.jflex javac LexicalSongParser.java java LexicalSongParser example_song.txt
 */
class LexicalSongParser {
	 ...
	 */
	private static final String ZZ_CMAP_PACKED = "\11\0\1\6\1\7\1\10\1\10\1\6\22\0\1\6\17\0\12\0" + "\7\0\32\1\1\2\1\0\1\3\3\0\32\1\1\4\1\0\1\5"
	...
	private static final String ZZ_ACTION_PACKED_0 = "\1\0\1\1\1\2\2\1\1\3\1\4\1\5\1\0" + "\1\6\1\0\1\7";
	...
	private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\11\0\22\0\33\0\44\0\11\0\11\0\11" + "\0\33\0\11\0\44\0\11";
	...
	private static final String ZZ_TRANS_PACKED_0 = "\1\2\1\3\1\4\1\2\1\5\1\2\1\6\1\7" + "\1\10\12\0\1\3\7\0\3\11\1\12\5\11\5\13" + "\1\14\3\13";
	...
	private static final String ZZ_ATTRIBUTE_PACKED_0 = "\1\0\1\11\3\1\3\11\1\0\1\11\1\0\1\11";
		...
		while (true) {
			...
			if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
				...
				case 8:
					break;
				case 2: {
					SongElement se = new SongElement("WORD", yyline, yycolumn, yytext());
					songElements.add(se);
//					System.out.printf("*** found word-match [%s] at line %d, column %d\n", yytext(), yyline, yycolumn);
				}
				case 9:
					break;
				case 3: {
					SongElement se = new SongElement("WHITESPACE", yyline, yycolumn, " ");
					songElements.add(se);
//					System.out.println("Whitespace");
				...
				case 10:
					break;
				case 4: {
					SongElement se = new SongElement("LINEBREAK", yyline, yycolumn, null);
					songElements.add(se);
//					System.out.println("Linebreak");
				...
				case 12:
					break;
				case 6: {
					SongElement se = new SongElement("CHORD", yyline, yycolumn, yytext().replace("[", "").replace("]", ""));
					songElements.add(se);
//					System.out.printf("*** found chord-match [%s] at line %d, column %d\n", yytext(), yyline, yycolumn);
				}
				case 13:
					break;
				case 7: {
					SongElement se = new SongElement("CHORDPRO", yyline, yycolumn, yytext());
					songElements.add(se);
//					System.out.printf("*** found chordpro-syntax [%s] at line %d, column %d\n", yytext(), yyline, yycolumn);
				}
				case 14:
					break;
				default:
